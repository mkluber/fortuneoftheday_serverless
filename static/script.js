...
function UpdateFortune() {
  ...
  //Get the form element by id
  const sampleForm = document.getElementById("UpdateFortuneForm");
  ...
  sampleForm.addEventListener("submit", async (e) => {
     ...
     * Take the URL from the form's `action` attribute.
     */
    let url = 'https://api.outworldindustries.com/updatefortune';
...
function DeleteFortune() {
  ...
  //Get the form element by id
  const sampleForm = document.getElementById("DeleteFortuneForm");
  ...
  sampleForm.addEventListener("submit", async (e) => {
     ...
     * Take the URL from the form's `action` attribute.
     */
    let url = 'https://api.outworldindustries.com/deletefortune';
